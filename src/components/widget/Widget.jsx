...
const Widget = ({ icon, title, subtitle, detail, trend }) => {
  return (
    <Card extra="p-4 rounded-[24px] bg-white/50 dark:bg-navy-800/50 backdrop-blur-xl border border-gray-300 dark:border-white/20 group hover:shadow-2xl transition-all duration-500">
